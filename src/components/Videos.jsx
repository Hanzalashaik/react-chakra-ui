  ...
  return (
    <Stack direction={['column','row']} h={'120vh'}>
        <VStack w={'full'}>
            ...
            ></video>
            <Box alignItems={'flex-start'} p={'8'} w={'full'} overflow={'auto'} >
            <Heading>
                Sample Video
            </Heading>
            <Text>This a description of a sample video.Lorem ipsum dolor sit, amet consectetur adipisicing elit.</Text>
            </Box>
        </VStack>
        <VStack border={['none','0.4px solid mediumorchid']}  margin={'20px 20px 20px 50px'}></VStack>
